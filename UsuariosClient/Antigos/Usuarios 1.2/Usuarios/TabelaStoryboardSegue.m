...
-(void)executar:(UIStoryboardSegue *)segue sender:(id)sender viewController:(SenhaViewController *)view {
    ...
    UISplitViewController *split = (UISplitViewController *)segue.destinationViewController;
    
    UsuariosTableViewController *tabela = (UsuariosTableViewController *)[[split.viewControllers firstObject] topViewController];
